      ...
      <div class="row">
        <div class="col-lg-5">
          <div class="about__img">
            ...
            <a href="https://www.youtube.com/watch?v=RpvAmG1NNN0" class="play-btn video-popup"><img src="img/about/video-play.png" alt="" /></a>
          </div>
        </div>
        <div class="col-lg-6 offset-lg-1">
          <div class="about__text">
            ...
            <p class="first_para">
              Where a powerful web presence has become a vital ingredient of
              your branding
            </p>
            <p class="last_para">
              Unfortunately, many graphic design firms who position
              themselves as advertising agencies believe that branding your
              corporate identity is all about developing great looking
              visual solutions.
            </p>
      ...
      <div class="col-lg-4 col-md-4">
        <div class="about__item">
          ...
          <p>
            ...
            accurate information. Prompt information is vital for people who
            want to keep the
          </p>
        </div>
      </div>
      ...
      <div class="col-lg-6">
        <div class="history__text nice-scroll">
          <div class="history__item">
            ...
            <p>
              Paypopup.com is a four year old online advertising complex
              which consists thousands of specialized websites in providing
              unique
            </p>
          </div>
          <div class="history__item">
        ...
        <div class="team__item set-bg" data-setbg="img/team/team-1.jpg">
          <div class="team__text">
            ...
            <p>
              ...
              condimentu eget. Vivamus non turpis elit. Aenean ultricies
              nisl sit amet.
            </p>
...
<!-- Contact Begin -->
<?php include("includes/contactft.php") ?>
